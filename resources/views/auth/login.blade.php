...
<head>
    ...
    <title>Đăng nhập — Fieldcraft</title>
...
<body>
    <form class="card" method="POST" action="{{ route('login.store') }}">
        ...
        <h1>Đăng nhập</h1>
        <p class="subtitle">Quản lý hồ sơ và lịch sử đơn hàng của bạn.</p>
        ...
        <div class="footer-links">
            <a class="footer-link" href="{{ route('register') }}">Chưa có tài khoản? <strong>Đăng ký ngay</strong></a>
